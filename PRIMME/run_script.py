...
def main(args):
    ...
    if args.grain_shape == "circular" or args.grain_shape == "square":
        grain_sizes[1] = args.radius
...
if __name__ == "__main__":
    ...
    parser.add_argument("--radius", type=int, default=64, help="Radius of the grains generated by voroni2image.")
